...
document.addEventListener('loaded', (e) => {
  ...
  TL.timelines.main
    ...
    .from('#stars', { duration: 1.5, scale: 0, ease: 'power4.out', svgOrigin: '80px 300px' }, TL.setCurTime('screen2', 0.6))
    ...
    .to('#stars path', { duration: 0.4, scale: 3, opacity: 0, svgOrigin: '80px 300px', ease: 'none' }, TL.setCurTime('screen3', 0))
    .to('#button', { duration: 0.4, x: -10, y: -268, scale: 0.932, transformOrigin: '50% 50%', ease: 'power3.out' }, TL.setCurTime('screen3', 0))
    .from('#date', { duration: 0.4, opacity: 0, x: 50, ease: 'power3.out' }, TL.setCurTime('screen3', 0.2))
    .from('.claims', { duration: 0.8, opacity: 0, x: 70, ease: 'power3.out', stagger: 0.2 }, TL.setCurTime('screen3', 0.4))
    .from('#iphone', { duration: 2, opacity: 0, y: -30, ease: 'power4.out' }, TL.setCurTime('screen3', 0.6))
    .from('#apple', { duration: 2, opacity: 0, y: 30, ease: 'power4.out' }, TL.setCurTime('screen3', 0.6))
    ...
    .to('#iphone', { duration: 1, scale: 0.868, x: 2, y: -54, ease: 'power4.out' }, TL.setCurTime('screen4', 0))
    .to('#apple', { duration: 1, scale: 0.873, x: 3, y: -58, ease: 'power4.out' }, TL.setCurTime('screen4', 0))
