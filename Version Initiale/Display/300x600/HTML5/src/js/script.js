...
document.addEventListener('loaded', (e) => {
  ...
  TL.timelines.main
    ...
    .from('#stars', { duration: 1.5, scale: 0, ease: 'power4.out', svgOrigin: '150px 300px' }, TL.setCurTime('screen2', 0.6))
    ...
    .to('#stars path', { duration: 0.4, scale: 3, opacity: 0, svgOrigin: '150px 300px', ease: 'none' }, TL.setCurTime('screen3', 0))
    .to('#button', { duration: 0.4, x: -74, y: -271, scale: 0.535, transformOrigin: '50% 50%', ease: 'power3.out' }, TL.setCurTime('screen3', 0))
    ...
    .to('#iphone', { duration: 1, scale: 0.7885, y: -61, ease: 'power4.out' }, TL.setCurTime('screen4', 0))
    .to('#apple', { duration: 1, scale: 0.79, x: 6, y: -69, ease: 'power4.out' }, TL.setCurTime('screen4', 0))
