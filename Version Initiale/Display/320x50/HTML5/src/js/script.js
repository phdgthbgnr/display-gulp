...
document.addEventListener('loaded', (e) => {
  ...
  TL.timelines.main
    ...
    .from('#stars', { duration: 1.5, scale: 0, ease: 'power4.out', svgOrigin: '160px 26px' }, TL.setCurTime('screen2', 0.6))
    ...
    .to('#stars path', { duration: 0.4, scale: 3, opacity: 0, svgOrigin: '160px 26px', ease: 'none' }, TL.setCurTime('screen3', 0))
    .to('#button', { duration: 0.4, x: -131, y: -17, scale: 0.56, transformOrigin: '50% 50%', ease: 'power3.out' }, TL.setCurTime('screen3', 0))
    ...
    .to('#iphone', { duration: 0.6, scale: 0.684, x: -25, ease: 'power4.out' }, TL.setCurTime('screen4', 0))
