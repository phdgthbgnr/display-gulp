...
document.addEventListener('loaded', (e) => {
  ...
  TL.timelines.main
    ...
    .from('#stars', { duration: 1.5, scale: 0, ease: 'power4.out', svgOrigin: '364px 47px' }, TL.setCurTime('screen2', 0.6))
    ...
    .to('#stars path', { duration: 0.4, scale: 3, opacity: 0, svgOrigin: '364px 47px', ease: 'none' }, TL.setCurTime('screen3', 0))
    .to('#button', { duration: 0.4, x: -313, y: -31, scale: 0.6, transformOrigin: '50% 50%', ease: 'power3.out' }, TL.setCurTime('screen3', 0))
    ...
    .to('#iphone', { duration: 0.6, scale: 0.6, y: 2, x: -68, ease: 'power4.out' }, TL.setCurTime('screen4', 0))
    .from('.argus', { duration: 0.6, opacity: 0, x: 30, ease: 'power3.inOut', stagger: 0.15 }, TL.setCurTime('screen4', 0.2))
