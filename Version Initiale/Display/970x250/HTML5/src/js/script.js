...
document.addEventListener('loaded', (e) => {
  ...
  TL.timelines.main
    ...
    .from('#stars', { duration: 1.5, scale: 0, ease: 'power4.out', svgOrigin: '486px 129px' }, TL.setCurTime('screen2', 0.6))
    ...
    .to('#stars path', { duration: 0.4, scale: 3, opacity: 0, svgOrigin: '486px 129px', ease: 'none' }, TL.setCurTime('screen3', 0))
    .to('#button', { duration: 0.4, x: -394, y: -98, scale: 0.53, transformOrigin: '50% 50%', ease: 'power3.out' }, TL.setCurTime('screen3', 0))
    ...
    .from('#iphone', { duration: 2, opacity: 0, y: 70, ease: 'power4.out' }, TL.setCurTime('screen3', 0.6))
    ...
    .to('.claims', { duration: 0.3, y: -40, ease: 'power2.inOut' }, TL.setCurTime('screen4', 0))
